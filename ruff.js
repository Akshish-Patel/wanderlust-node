const sampleListings = [
  ...
  for(listing of sampleListings)
  {
    ...
    console.log(`("${title}",, "${desc}",, "${url}",, ${price},, "${loc}",, "${country}"),,,`)
  }
